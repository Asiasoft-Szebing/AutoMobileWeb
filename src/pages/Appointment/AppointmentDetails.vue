    ...
    <div v-if="item">
      ...
      <div class="mb-6 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2 ">
          <button
            class=" inline-flex rounded-lg px-4 py-2 text-sm font-medium transition-colors border border-gray-300 bg-gray-200 text-gray-700 hover:bg-gray-50">
            <ArrowLeftIcon class="h-4 w-4" /> 
            <RouterLink to="/Appointment/All">Back</RouterLink>
          </button>
          <button
            class="rounded-lg px-4 py-2 text-sm font-medium transition-colors border border-red-600 text-red-600 hover:bg-red-300 ">Cancel</button>
          <button
            class="rounded-lg px-4 py-2 text-sm font-medium transition-colors bg-blue-600 text-white hover:bg-blue-700">Rescheduled</button>
          <button
            class="rounded-lg px-4 py-2 text-sm font-medium transition-colors bg-blue-600 text-white hover:bg-blue-700">Confirm</button>
        </div>
      </div>
          ...
          <table class="w-full min-w-[600px]">
            ...
            <tbody class="divide-y divide-gray-200">
              ...
              <tr>
                ...
                <td class="px-4 py-3 text-gray-600">Previous complaint about delay in service on 2024-12-10, resolved
                  with
                  a free upgrade.</td>
